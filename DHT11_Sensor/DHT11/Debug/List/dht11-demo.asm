...
; 0000 0027 void readTemp(int temp) {
; 0000 0028      int x;
; 0000 0029      x = temp;
;	temp -> Y+2
;	x -> R16,R17
; 0000 002A      lcd_putchar(x/10+48);
; 0000 002B      x = x % 10;
; 0000 002C      lcd_putchar(x+48);
; 0000 002D }
;
;void main(void)
; 0000 0030 {
...
; 0000 008D // ADC Auto Trigger Source: Free Running
; 0000 008E ADMUX=FIRST_ADC_INPUT | ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 008F ADCSRA=(1<<ADEN) | (1<<ADSC) | (1<<ADATE) | (0<<ADIF) | (1<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(235)
	OUT  0x6,R30
...
; 0000 00AB       {
; 0000 00AC 
; 0000 00AD       lcd_gotoxy(1,0);
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00AE       lcd_putsf("T = ");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 00AF 
; 0000 00B0       }
